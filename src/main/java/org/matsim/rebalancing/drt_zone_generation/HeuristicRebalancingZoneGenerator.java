...
public class HeuristicRebalancingZoneGenerator {
    ...
    public static void main(String[] args) {
        ...
        // Current input arguments: input network path, output network path,
    ...
    public static class ZoneGeneratorBuilder {
        ...
        public HeuristicRebalancingZoneGenerator build() {
			...
			SparseMatrix freeSpeedTravelTimeSparseMatrix = TravelTimeMatrices.calculateTravelTimeSparseMatrix(routingParams, sparseMatrixMaxDistance,
				0, 0).get();
